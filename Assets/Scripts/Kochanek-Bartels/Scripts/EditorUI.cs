...
public class EditorUI : MonoBehaviour {
    ...
    void WindowPoint(int windowID) 
	{
		...
		{
//			if(Spline.Select.LinePoints.Count>3)
//			{
//				Spline.Select.LinePoints.Remove(Point.Select);
...
//		Spline.Select.maxVerticesCurve = (int)GUILayout.HorizontalSlider(Spline.Select.maxVerticesCurve,3, 100);
//		GUILayout.EndVertical();
//		
