...
//				for(int i=0; i<spline.LinePoints.Count-1;i++)
//				{
//					DrawLine(spline.LinePoints[i].Pos,spline.LinePoints[i+1].Pos);
//				}
//				if(spline.closed)
//				{
//					DrawLine(spline.LinePoints[0].Pos,spline.LinePoints[spline.LinePoints.Count-1].Pos);
//				}
//			}
//			if(spline.isSelect)
//				GL.Color( Color.red );
